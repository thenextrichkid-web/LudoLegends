...
from app.schemas.tournament import TournamentCreate, TournamentUpdate, TournamentResponse, TournamentList, JoinTournament
...
from app.schemas.common import (
    SuccessResponse, ErrorResponse, PaginatedResponse, LeaderboardResponse,
    LeaderboardPeriod, GiveawayResponse, NotificationResponse, ReferralStats,
)
